...
const HistoryTable: React.FC = () => {
  ...
  const [showGlobalSummary, setShowGlobalSummary] = useState(true); // Default to showing the summary
  ...
  // Show at least the summary if we have founders but no history yet
  if (globalScores && history.length === 0) {
    return (
      <motion.div 
